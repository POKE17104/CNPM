...
//                 .HasKey(static ok => new { ok.OrderId, ok.KoiFishId });

//             // Thiết lập mối quan hệ nhiều-nhiều giữa Orders và KoiFishes
//             modelBuilder.Entity<OrderKoi>()
//                 .HasOne(static ok => ok.Order)
//                 .WithMany(static o => o.OrderKois)
//                 .HasForeignKey(static ok => ok.OrderId);

//             modelBuilder.Entity<OrderKoi>()
//                 .HasOne(static ok => ok.KoiFish)
//                 .WithMany(static k => k.OrderKois)  // Loại bỏ từ khóa 'static' ở đây
//                 .HasForeignKey(static ok => ok.KoiFishId);
    ...
    public class KoiContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderKoi>()
                ...
                .WithMany(k => k.OrderKois)  // Loại bỏ từ khóa 'static' ở đây
